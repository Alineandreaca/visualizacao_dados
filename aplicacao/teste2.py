...
app.layout = html.Div(
    children=[
        ...
        html.H2(children='Gráficos de Barras', className="texto"),
            #html.Div(id='texto'),
            html.Div(className="container", children=[  
                html.P('''O gráfico de barras a seguir apresenta a  distribuição das soma das pontuações médias obtidas pelos alunos em avaliações do Pisa. Este tipo de gráfico é uma ferramenta visual eficaz para comparar os resultados de diferentes
        ...
        html.Div(className="container", children=[  
                html.P('''Também conhecido como  heatmap a seguir apresenta a distribuição das pontuações obtidas pelos alunos em avaliações do Pisa. 
                Este gráfico de calor é uma ferramenta visual que utiliza a intensidade cores para representar os valores das pontuações, facilitando a identificação de padrões e tendências nos dados.
